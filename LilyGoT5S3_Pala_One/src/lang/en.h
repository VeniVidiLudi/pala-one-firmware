...
#define D_WEB_ORIENT_LABEL          "Orientation"
#define D_WEB_ORIENT_PORTRAIT       "Portrait"
#define D_WEB_ORIENT_LANDSCAPE      "Landscape"
#define D_WEB_ORIENT_HINT           "Rotates the whole interface. Portrait is the natural book layout; landscape puts the button on the top edge."
...
#define D_WEB_SCREENSAVER_SPECS     "Upload raw XBM bytes: <b>65280 bytes</b>, 540&times;960 px, 1-bit, LSB-first, 68 bytes per row."
...
#define D_WEB_ERR_EPUB_TRUNCATED    "Upload incomplete (SD full or write error)"
#define D_WEB_ERR_EPUB_CONVERT_FAILED "EPUB conversion failed"
...
#define D_WEB_SLEEP_ERR_SIZE        "Sleep image must be exactly 65280 bytes"
...
#define D_WEB_SS_EDITOR_INTRO       "Drop an image into the editor, then upload it to a rotation slot or as the single legacy screensaver. All images render as 540&times;960 1-bit (65280 bytes)."
