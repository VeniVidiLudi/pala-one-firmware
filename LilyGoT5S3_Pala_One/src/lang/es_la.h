...
#define D_WEB_ORIENT_LABEL          "Orientación"
#define D_WEB_ORIENT_PORTRAIT       "Vertical"
#define D_WEB_ORIENT_LANDSCAPE      "Horizontal"
#define D_WEB_ORIENT_HINT           "Gira toda la interfaz. Vertical es el formato natural de libro; horizontal deja el botón en el borde superior."
...
#define D_WEB_SCREENSAVER_SPECS     "Suba bytes XBM en bruto: <b>65280 bytes</b>, 540&times;960 px, 1 bit, LSB primero, 68 bytes por fila."
...
#define D_WEB_ERR_EPUB_TRUNCATED    "Subida incompleta (tarjeta SD llena o error de escritura)"
#define D_WEB_ERR_EPUB_CONVERT_FAILED "Error al convertir el EPUB"
...
#define D_WEB_SLEEP_ERR_SIZE        "La imagen de suspensión debe ser exactamente 65280 bytes"
...
#define D_WEB_SS_EDITOR_INTRO       "Arrastra una imagen al editor y súbela a una ranura de rotación o como el salvapantallas único heredado. Todas las imágenes se renderizan en 540&times;960 1 bit (65280 bytes)."
